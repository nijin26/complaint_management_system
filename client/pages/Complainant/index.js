  ...
  return (
    <>
      <div className="flex justify-center my-3 [&>*]:mx-2">
        <Button
          outlined={true}
          onClick={() => router.push("/Complainant/FileComplaint")}
        >
          File Complaint
        </Button>
        ...
        <Button
          outlined={true}
          onClick={() => router.push("/Complainant/ListOfComplaints")}
        >
          View List of Complaints
        </Button>
      </div>
      <div className="flex justify-center">
        <div className="my-8 bg-white border border-gray-300 rounded-lg p-4 w-96 min-h-[60vh] ">
